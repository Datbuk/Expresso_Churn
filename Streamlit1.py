...
st.image('pngwing.com (1).png',width = 650) #---- to give it image
...
if st.button('Press To Predict'):
    ...
    st.image('pngwing.com (3).png', width = 40)
    st.success(f'predicted CHURN with provided information is {predicted}')

st.markdown('<br><br>', unsafe_allow_html= True)
st.markdown("<h8>Expresso Churn built by Oladele Olubukola</h8>", unsafe_allow_html=True)
